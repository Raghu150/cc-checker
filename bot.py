...
async def helpstr(message: types.Message):
    ...
    await message.reply(
        "Hello how to use <code>/chk cc/mm/yy/cvv</code>\nREPO <a href='https://github.com/raghu150/cc-checker'>Here</a>"
    )
...
async def ch(message: types.Message):
    ...
    load = {
      ...
      "spc_eligible": "false",
      "key": "pk_test_51LLN7LCxhhWJPVGWhEZiEPaUVnVnqGBxuC3wlSqGxtrASPEQtOwciQndDabaf8tSd6lLFbgcgL2fKZFahaLgwvu900t3rJI2K6",
